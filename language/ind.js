...
exports.registered = (namaUser, umurUser, serialUser, time, sender) => {
	return`*「 DATA FORMULIR PENDAFTARAN  」*\n╭━─━─━─━─≪✠≫─━─━─━─━╮\n\n❍ NAMA :  ${namaUser}\n❍ NOMOR : wa.me/${sender.split("@")[0]}\n❍ UMUR : ${umurUser}\n❍ joined : ${time}\n❍ *NS* : ${serialUser}\n❍ desc : ketik #menu untuk mendapatkan fitur dari APBOT\n╰━─━─━─━─≪✠≫─━─━─━─━╯\n▌│█║▌│ █║▌│█│║▌║\n*DEVELOPER APBOT*`
}
...
exports.menu = (pushname, prefix, getLevelingLevel, getLevelingXp, sender, reqXp, _registered, uangku, role) => { 
	return `
	▬▬|| Welcome To APBOT ||▬▬
*╭─͙─͙─͙─͙─͙─͙─͙─͙─͙─͙─͙─͙͙─͙─͙𒀭𖠄ྀྀ࿐*
*┊❍╭━─━─━─━─≪✠≫─━─━─━─━╮*
*┆💠 Creator : AGUSZ PAKEZ*
...
🔰 *YOUR INFO* 🔰
  ...
  💠 jumlah peserta : ${_registered.length}
═════════════════════════
💠    *〈 ABOUT 〉*
  ❇️ ${prefix}info
  ❇️ ${prefix}snk
